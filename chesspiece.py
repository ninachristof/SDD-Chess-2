...
class chesspiece:
    ...
    # These are all possible_moves that also (1) don't require going through pieces and (2) don't leave the king in check
    legal_moves = []
    ...
    def __init__(self, x, y, color):
        ...
        if (color == "white"):
            self.sprite = pygame.transform.scale(
                pygame.image.load("resources/Chess_plt60.png"), (80, 80))
        elif (color == "black"):
            self.sprite = pygame.transform.scale(
                pygame.image.load("resources/Chess_pdt60.png"), (80, 80))
        self.find_moves(x, y)
...
class knight(chesspiece):
    def __init__(self, x, y, color):
        ...
        if (color == "white"):
            self.sprite = pygame.transform.scale(
                pygame.image.load("resources/Chess_nlt60.png"), (80, 80))
        elif (color == "black"):
            self.sprite = pygame.transform.scale(
                pygame.image.load("resources/Chess_ndt60.png"), (80, 80))
        self.find_moves(x, y)
...
class king(chesspiece):
    def __init__(self, x, y, color):
        ...
        if (color == "white"):
            self.sprite = pygame.transform.scale(
                pygame.image.load("resources/Chess_klt60.png"), (80, 80))
        elif (color == "black"):
            self.sprite = pygame.transform.scale(
                pygame.image.load("resources/Chess_kdt60.png"), (80, 80))
        self.find_moves(x, y)
...
class rook(chesspiece):
    def __init__(self, x, y, color):
        ...
        if (color == "white"):
            self.sprite = pygame.transform.scale(
                pygame.image.load("resources/Chess_rlt60.png"), (80, 80))
        elif (color == "black"):
            self.sprite = pygame.transform.scale(
                pygame.image.load("resources/Chess_rdt60.png"), (80, 80))
        self.find_moves(x, y)
    ...
    def find_moves(self, x, y):
        ...
        while (iter >= 0):
            ...
            # Add the square to the possible moves.
            possible_up.append((iter, y))
            iter -= 1  # Move up.
        ...
        possible_noncapture.extend(powerup_move)
        possible_capture = [possible_up, possible_right,
                            possible_down, possible_left]
        possible_capture.extend(powerup_capture)
...
class bishop(chesspiece):
    def __init__(self, x, y, color):
        ...
        if (color == "white"):
            self.sprite = pygame.transform.scale(
                pygame.image.load("resources/Chess_blt60.png"), (80, 80))
        elif (color == "black"):
            self.sprite = pygame.transform.scale(
                pygame.image.load("resources/Chess_bdt60.png"), (80, 80))
        self.find_moves(x, y)
    ...
    def find_moves(self, x, y):
        ...
        possible_noncapture.extend(powerup_move)
        possible_capture = [
            possible_upRight, possible_downRight, possible_downLeft, possible_upLeft]
        possible_capture.extend(powerup_capture)
...
class queen(bishop, rook):
    def __init__(self, x, y, color):
        ...
        if (color == "white"):
            self.sprite = pygame.transform.scale(
                pygame.image.load("resources/Chess_qlt60.png"), (80, 80))
        elif (color == "black"):
            self.sprite = pygame.transform.scale(
                pygame.image.load("resources/Chess_qdt60.png"), (80, 80))
        self.find_moves(x, y)
