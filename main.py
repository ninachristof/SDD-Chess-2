...
def main():
    ...
    parser.add_argument("-m" "--menu", action="store_true",
                        help="takes player to main menu")
    parser.add_argument("-H" "--host", action="store_true",
                        help="skip main menu and host a game")
    parser.add_argument("-c" "--connect", action="store_true",
                        help="skip main menu and try to connect to host")
    parser.add_argument("-i", type=str, default="127.0.0.1",
                        help="ip address of host")
    parser.add_argument("-p", type=int, default=2020, help="port number")
    # does nothing right now
    parser.add_argument("-b", type=str, help="filename")
